...
export let populateProgramBreadCrumbNew = ( showObjectContext, openedObject ) => {
    ...
    //On updation of XRT's in future the following line of code change will no longer required.
    document.getElementsByClassName( 'aw-layout-panelBody' ).length > 0 && document.getElementsByClassName( 'aw-layout-panelBody' )[0].hasAttribute( 'style' ) && document.getElementsByClassName( 'aw-layout-panelBody' )[0].removeAttribute( 'style' );
