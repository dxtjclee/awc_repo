...
export let updateSelections = function( selectionData, openedObject ) {
    if( selectionData ) {
        let showObj = openedObject ? openedObject : selectionData.pselected;
        selectionData.update( { ...selectionData.getValue(), selected: [ showObj ] } );
    }
};
