...
export let initializeDefaultProps = function( fields, subPanelContext ) {
    ...
    //Added this additional property arg to set valueUpdated to true
    const additionalProps = { markModified : true, runValidation : true };
    fields.xrtState.xrtVMO.props.prg0TargetParentPlan.setLovVal( { lovEntry }, null, additionalProps );
};
