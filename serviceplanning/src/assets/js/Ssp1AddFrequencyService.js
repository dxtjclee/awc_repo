 ...
 */
 ...
 export let saveFrequency = function( data ) {
     ...
     if(data.phraseSeperator.dbValue !== "" ){
         expression = data.phraseSeperator.uiValue + " ";
     }
     if(data.keywords.dbValue !== "" && data.frequencyValue.dbValue === "" && ( data.frequencyCharacteristics.dbValue === "Manufacture Date" || data.frequencyCharacteristics.dbValue === "Install Date")){
         expression = expression + data.keywords.uiValue + " " + data.frequencyCharacteristics.uiValue;
     }
     if(data.keywords.dbValue !== "" && data.frequencyValue.dbValue !== "" && data.frequencyCharacteristics.dbValue !== ""){
         expression = expression + data.keywords.uiValue + " " + data.frequencyValue.uiValue + " " + data.frequencyCharacteristics.uiValue;
     }
     if(data.keywords.dbValue !== "" && data.frequencyValue.dbValue === "" && data.characteristicType === 'Observation' && data.frequencyOperators.dbValue !== "" && data.operatorsValue.dbValue !== ""){
         expression = expression + data.keywords.uiValue + " " + data.frequencyCharacteristics.uiValue + " " + data.frequencyOperators.dbValue + " " + data.operatorsValue.uiValue;
     }
     if(data.keywords.dbValue !== "" && data.frequencyValue.dbValue === "" && data.characteristicType === 'Date' && data.frequencyDateTime.uiValue !== ""){
         expression = expression + data.keywords.uiValue + " " + data.frequencyCharacteristics.uiValue + " " + getDate(data.frequencyDateTime.dbValue);
     }
     if(data.toleranceSign.dbValue !== "" && data.toleranceValue.dbValue !== ""){
         expression = expression + " " + data.toleranceSign.uiValue + " " + data.toleranceValue.uiValue;
         if(data.toleranceType.dbValue !== ""){
             expression = expression + " " + data.toleranceType.uiValue;
         }
     }
     if(data.afterUntil.dbValue !== "" && data.afterUntilValue.dbValue === "" && ( data.afterUntilCharacteristic.dbValue === "Manufacture Date" || data.afterUntilCharacteristic.dbValue === "Install Date")){
         expression = expression + " " + data.afterUntil.uiValue + " " + data.afterUntilCharacteristic.uiValue;
     }
     if(data.afterUntil.dbValue !== "" && data.afterUntilValue.dbValue !== "" && data.afterUntilCharacteristic.dbValue !== ""){
         expression = expression + " " + data.afterUntil.uiValue + " " + data.afterUntilValue.uiValue + " " + data.afterUntilCharacteristic.uiValue;
     }
     if(data.afterUntil.dbValue !== "" && data.afterUntilValue.dbValue === "" && data.characteristicTypeAdvanced === 'Observation' && data.advancedOperators.dbValue !== ""  && data.advancedOperatorsValue.dbValue !== "" ){
         expression = expression + " " + data.afterUntil.uiValue + " " + data.afterUntilCharacteristic.uiValue + " " + data.advancedOperators.dbValue + " " + data.advancedOperatorsValue.uiValue;
     }
     if(data.afterUntil.dbValue !== "" && data.afterUntilValue.dbValue === "" && data.characteristicTypeAdvanced === 'Date' && data.advancedDateTime.uiValue !== ""){
         expression = expression + " " + data.afterUntil.uiValue + " " + data.afterUntilCharacteristic.uiValue + " " + getDate(data.advancedDateTime.dbValue);
     }
 ...
 export let searchCharacteristicsAfterUntil = function( data ) {
     ...
     if( data.afterUntil.dbValues[0] && data.afterUntil.dbValues[0] !== '' ) {
         outputVals = [
             ...
             { propDisplayValue: data.i18n.Days, propInternalValue: 'Days' },
             { propDisplayValue: data.i18n.Months, propInternalValue: 'Months' },
             { propDisplayValue: data.i18n.Years, propInternalValue: 'Years' },
             { propDisplayValue: data.i18n.Calendar, propInternalValue: 'Calendar' }
         ];
         if( data.afterUntil.dbValues[0] === 'After' ) {
             var concatVals = [
                 { propDisplayValue: data.i18n.InstallDate, propInternalValue: 'Install Date' },
                 { propDisplayValue: data.i18n.ManufactureDate, propInternalValue: 'Manufacture Date' }
             ];
