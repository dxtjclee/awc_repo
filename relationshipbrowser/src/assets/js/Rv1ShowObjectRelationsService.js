...
function _setModelProp( modelObject, direction, isHidden ) {
    ...
    if(  modelObject.props.awp0CellProperties.uiValues[modelObject.props.awp0CellProperties.uiValues.length - 1] !== direction ) {
        modelObject.props.awp0CellProperties.uiValues.push( direction );
    }
