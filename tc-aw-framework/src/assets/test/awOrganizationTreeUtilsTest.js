...
describe( 'Testing awOrganizationTreeUtilsTest', function() {
    ...
    it( 'test getNodesToBeExpanded', function() {
        let searchState = {
            categories: [ {
                internalName: 'Group.group_name',
                displayName: 'Group'
    ...
    it( 'Check getNodesToBeExpanded', function() {
        var selectedNodes = {
            type: 'Role',
            uid: 'CFnRcc6AZi1NjB',
            alternateID: 'CFnRcc6AZi1NjB,ywjRccJVZi1NjB,SiteLevel',
            parent:{
                type: 'Group',
                uid: 'ywjRccJVZi1NjB',
                alternateID: 'ywjRccJVZi1NjB,SiteLevel',
                parent:{
                    type: 'SiteLevel',
                    uid: 'SiteLevel'
                }
        ...
        var expandIds = [];
        _awOrganizationTreeUtils.getNodesToBeExpanded( selectedNodes, expandIds );
        expect( expandIds.length ).toEqual( 2 );
        expect( expandIds[0] ).toEqual( 'CFnRcc6AZi1NjB,ywjRccJVZi1NjB,SiteLevel' );
        expect( expandIds[1] ).toEqual( 'ywjRccJVZi1NjB,SiteLevel' );
    } );
