...
export const getNodesToBeExpanded = function( selectedNodes, expandIds ) {
    if ( selectedNodes && selectedNodes.uid !== 'SiteLevel' ) {
        ...
        getNodesToBeExpanded( selectedNodes.parent, expandIds );
    }
};
 ...
 */
export let loadTreeTableData = function( searchInput, columnConfigInput, saveColumnConfigData, treeLoadInput, searchState, grid ) {
    assert( searchInput, 'Missing search input' );
    assert( treeLoadInput, 'Missing tree load input' );

    return AwPromiseService.instance.resolve( _buildTreeTableStructure( searchInput, columnConfigInput, saveColumnConfigData, treeLoadInput, searchState, grid ) );
};
...
function _buildTreeTableStructure( searchInput, columnConfigInput, saveColumnConfigData, treeLoadInput, searchState, grid ) {
    ...
    return getSoaResponse( soaSearchInput, columnConfigInput, saveColumnConfigData, searchState ).then( function( response ) {
        ...
        if( treeLoadInput.grid && searchState.expansionStateCaching ) {
            ...
            if( treeLoadResult.grid.gridOptions ) {
                ...
                treeLoadResult.grid.gridOptions.enableExpansionStateCaching = searchState.expansionStateCaching ? searchState.expansionStateCaching : false;
            }
        }
