...
/**
 * Prepare the Primary search criteria when the project is opened or any filter applied in the project content location
 * @returns
 */
export const getPrimaryProjectCriteria = function( searchState ) {
    var criteria = '';
    if( AwStateService.instance.params.uid ) {
        ...
        if( mo ) {
            ...
            if ( wsoType.propertyDescriptorsMap ) {
