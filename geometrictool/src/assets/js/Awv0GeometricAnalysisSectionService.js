 ...
 */
export let geometricAnalysisSectionPanelRevealed = function( data, geometricSectionState, subPanelContext ) {
    ...
    subPanelContext.viewerContextData.getSectionManager().initializeSectionsFromContext( geometricSectionState, subPanelContext ).then( () => {
        let editData = updateEditSectionDetails( data, subPanelContext.viewerContextData );
...
export let revealPanelWhenSectionCreatedWithEntities = function( viewerContextData ) {
    ...
    if( viewId !== 'Awv0GeometricAnalysisSection' ) {
        AwTimeoutService.instance( function() {
            viewerContextService.activateViewerCommandDialog( 'Awv0GeometricAnalysisSection', viewerData, true );
        }, 1000 );
    }
...
export let cleanupGeoAnalysisSectionPanel = function( viewerData ) {
    ...
    viewerData.viewerContextData.updateViewerAtomicData( viewerContextService.VIEWER_ACTIVE_DIALOG_ENABLED, null );
};
