 ...
 */
export default class MentionsView extends ckeditor5ServiceInstance.ListView {
    /**
     * @inheritDoc
     */
    constructor( locale ) {
    ...
    _isItemVisibleInScrolledArea( item ) {
        return new ckeditor5ServiceInstance.Rect( this.element ).contains( new ckeditor5ServiceInstance.Rect( item.element ) );
    }
}
