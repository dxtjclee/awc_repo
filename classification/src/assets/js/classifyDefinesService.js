...
export const CLS_PROPERTY_ATTR_TYPE_BLOCK = 'SB';
export const CLS_PROPERTY_ATTR_TYPE_FRAME = 'SF';

export var _localeTextBundle = {};

export let loadConfiguration = async function() {
// Property for External Tree Update
    _localeTextBundle.SHOW_CHILDREN = await localeService.getLocalizedTextFromKey( 'treeTableMessages.TwistieTooltipCollapsed' );
    _localeTextBundle.HIDE_CHILDREN = await localeService.getLocalizedTextFromKey( 'treeTableMessages.TwistieTooltipExpanded' );
};
...
export const SML_ERR_TOO_MANY_VALUES = 71663;

export const POM_ERR_NO_ACCESS = 515001;
...
export default exports = {
    ...
    CLS_PROPERTY_ATTR_TYPE_BLOCK,
    CLS_PROPERTY_ATTR_TYPE_FRAME,
