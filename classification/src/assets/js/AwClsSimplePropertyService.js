...
export const awClsSimplePropertyServiceRenderFunction = (  props ) => {
    ...
    const isPanel = classifyState.isClassifyPanel;
    ...
    let className = isLocalizable && !updateMode ? 'aw-clspanel-L10NPropertyValContainer sw-property sw-component sw-row sw-readOnly' : 'aw-clspanel-extendedPropCreate';
    if ( updateMode ) {
