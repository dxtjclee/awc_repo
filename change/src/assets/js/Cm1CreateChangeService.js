...
export let getCreateInput = function( data, isSubmit, editHandler, participantInfo, derivedFromObjects ) {
    ...
    if( !isDerive ) {
        ...
        if( cmUtils.callNewSOAForDerive() ) {
            ...
            _getInputForDeriveOperationOldSOA( data, isSubmit, editHandler, derivedFromObjects )
...
export let getDeriveOptions = function( data ) {
    ...
    if ( appCtxSvc.ctx.mselected[0].type === 'CAW0Defect' && appCtxSvc.getCtx( 'pselected' ) !== undefined &&
 ...
 * @param {Object} derivedFromObjects - selected object to derive
 */
var _getInputForDeriveOperationOldSOA = function( data, isSubmit, editHandler, derivedFromObjects ) {
    var deferred = AwPromiseService.instance.defer();
    var allObjectUid = [];
    var selectedChangeObjects = derivedFromObjects;
    var isDerive = appCtxSvc.ctx.CreateChangePanel.isDerive;
