...
export let processResponseToStoreReportDefs = function( response, data ) {
    ...
    _.forEach( _inCtxReportDefs, ( repDefObj ) => {
        if( repDefObj.type === 'ReportDefinition' && ( repDefObj.props.rd_source.dbValues[ 0 ] === 'Teamcenter' || repDefObj.props.rd_source.dbValues[ 0 ] === OFFICE_TEMPLATE || repDefObj.props.rd_source.dbValues[ 0 ] === 'Active Workspace' ) ) {
            return repDefObj;
