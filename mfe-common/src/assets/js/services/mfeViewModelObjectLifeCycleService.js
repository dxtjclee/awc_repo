...
/**
 *
 * @param {ViewModelObject[]} vmos - a given viewModelObject array
 */
 export function addVmosForUpdateEvents( vmos ) {
    vmos.forEach( ( vmo ) => addVmoToCache( vmo ) );
}
...
export default exports = {
    ...
    deleteVmosFromCache,
    updateVmosOfGivenModelObjects,
    addVmosForUpdateEvents
};
