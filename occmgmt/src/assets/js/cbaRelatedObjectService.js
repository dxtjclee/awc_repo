...
/**
 * Creates performSearchViewModel5 SOA Input object as per provider name
...
export let getRelatedModelObjects = function( primaryObject, providerName, freshSOACallMode ) {
    ...
    if( makeSOACall ) {
        ...
        soaService.postUnchecked( 'Internal-AWS2-2023-06-Finder', 'performSearchViewModel5', _getPerformSearchSOAInput( primaryObject, providerName ) ).then( function( response ) {
