...
export let updateCBAContextOnRowSelection = function( target, value ) {
    ...
    occmgmtUtil.updateValueOnCtxOrState( '', { isRowSelected: isTrue }, target, true );
};
...
export let resetStructureForAutomatedUpdate = function( commandContext ) {
    if( commandContext && commandContext.occContext ) {
        let viewToReact = commandContext.occContext.viewKey === cbaConstants.CBA_SRC_CONTEXT ? cbaConstants.CBA_TRG_CONTEXT : cbaConstants.CBA_SRC_CONTEXT;
