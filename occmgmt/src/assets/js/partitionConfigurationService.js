...
const partitionPropertyHandler = {
    ...
    callbackFunction: ( overriddenPropertyPolicy ) => {
        occmgmtTreeTableDataService.updateOverriddenPropertyPolicy( overriddenPropertyPolicy, 'Awb0Element', _partitionProps );
    },
    condition: ( occContext ) => {
        ...
        !_.isUndefined( occContext.supportedFeatures ) && _.isUndefined( occContext.supportedFeatures['4GStructureFeature'] ) || occContext.openedObjectType === 'WorksetRevision' ) { return true; }
        return false;
    }
};
...
export let registerHandlerForOverriddenProperties = function( ) {
    occmgmtTreeTableDataService.registerOverriddenPropertyPolicyHandler( partitionPropertyHandler );
};
