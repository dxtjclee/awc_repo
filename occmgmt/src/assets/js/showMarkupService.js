...
const markupPropertyHandler = {
    ...
    condition: ( occContext ) => {
        if( !_.isUndefined( occContext.productContextInfo ) && !_.isUndefined( occContext.productContextInfo.props ) && ( !_.isUndefined( occContext.productContextInfo.props.awb0ShowChange ) ||
        !_.isUndefined( occContext.productContextInfo.props.awb0ShowMarkup ) ) && ( occContext.productContextInfo.props.awb0ShowMarkup.dbValues[0] === '1' ||
         occContext.productContextInfo.props.awb0ShowChange.dbValues[0] === '1' ) || occContext.isDuplicateEnabled )  { return true; }
        return false;
    }
};
