...
export let getTopAlignmentInput = function( trgTop, srcTop ) {
    ...
    let alignmentInput = [ {
        primaryObject: trgTopElement,
        secondaryObject: srcTopElement,
    ...
    if( cbaConstants.PRODUCT_EBOM === trgTopQualifierType ) {
        alignmentInput = [ {
            primaryObject: cdm.getObject( trgTopElement.props.items_tag.dbValues[ 0 ] ),
            secondaryObject: cdm.getObject( srcTopElement.props.items_tag.dbValues[ 0 ] ),
