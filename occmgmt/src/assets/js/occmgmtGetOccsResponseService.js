...
var _populateDisplayToggleOptions = function( displayToggleOptions, response, occContext ) {
    ...
    let PSEShowFilteredOutOccPref = !_.isUndefined( response.requestPref.PSEShowFilteredOutOccPref )
        ? response.requestPref.PSEShowFilteredOutOccPref[0] : occContext.displayToggleOptions
            .PSEShowFilteredOutOccPref;
    ...
    if ( !_.isUndefined( PSEShowFilteredOutOccPref ) ) {
        displayToggleOptions.PSEShowFilteredOutOccPref = PSEShowFilteredOutOccPref === 'true' || PSEShowFilteredOutOccPref === true;
    }
};
 ...
 */
export let getNewStateFromGetOccResponse = function( response, contextState, soaInput, uwDataProvider ) {
    let  c_uid;
    let pci_uid;
