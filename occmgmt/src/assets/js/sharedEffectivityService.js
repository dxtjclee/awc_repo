...
export let loadTopLevelAsEndItem = function( data, subPanelContext ) {
    ...
    if( contextVal ) {
        var topItemRevision = cdm.getObject( contextVal.productContextInfo.props.awb0Product.dbValues[ 0 ] );
...
export let getSelectedElements = function( data, subPanelContext ) {
    ...
    let totalFound = subPanelContext.occContext.selectedModelObjects.length;
