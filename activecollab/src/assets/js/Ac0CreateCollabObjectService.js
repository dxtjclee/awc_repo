...
var initCreateCollabObjectPanelSub = function( data, sharedData, newUserChipsObj ) {
    ...
    if ( convCtx.currentSelectedSnapshot || data.subPanelContext && data.subPanelContext.selectionData && data.subPanelContext.selectionData.selected && data.subPanelContext.selectionData.selected[0].type === 'Fnd0Snapshot' ) {
    ...
    if( addedSourceObjects ) {
        for( var i = 0; i < addedSourceObjects.length; i++ ) {
            ...
            var chipExisted = _.find( srcObjChips, function( chip ) {
                ...
                if( chip.theObject && chip.theObject.props.awb0UnderlyingObject ) {
