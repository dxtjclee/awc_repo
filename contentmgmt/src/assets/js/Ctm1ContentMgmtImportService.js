...
export let getImportTopicInputs = function( data ) {
    ...
    for( var i = 0; i < data.files.length; ++i ) {
        var input = {
            ...
            keyValueArgs: {
                Type: 'Import',
                Overwrite_existing: data.overwriteExistingCheckbox.dbValue.toString(),
                Find_by_content: data.findByContentCheckbox.dbValue.toString(),
                Find_by_XML_number: data.findByXMLNumberCheckbox.dbValue.toString(),
