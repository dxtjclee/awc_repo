...
function loadTitleofUpdatePopup( contextObject ) {
    const localTextBundle = localeService.getLoadedText( 'AdminMessages' );
    return localTextBundle.updateRevisionCommandDescription.format( contextObject );
}

function loadDataHeaderinPopup( contextObject ) {
    const localTextBundle = localeService.getLoadedText( 'AdminMessages' );
    return localTextBundle.availableRevisionTableTitle.format( contextObject );
}
export default {
    addVMOAndRevRuleToStructureContext,
    getWPStructuresList,
    getProductVariantsStructuresList,
    loadTitleofUpdatePopup,
    loadDataHeaderinPopup
};
