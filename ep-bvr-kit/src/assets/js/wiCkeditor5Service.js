...
import wiAddSymbolSchemaExtender from 'js/wiAddSymbol/wiAddSymbolSchemaExtender';
...
function getWiEditorConfiguration() {
    let config = {};
    config.extraPlugins = [ WIAutocomplete, WIPartsToolsPlaceholder, WIStandardTextPlaceholder, WIVisualsPlaceholder, WIAddSymbol, wiAddSymbolSchemaExtender ];
    config.language = 'en';
    config.toolbar = {
        items:[
    ...
    config.removePlugins = [ 'ImageResize' ];
    return config;
}
/**
 *
