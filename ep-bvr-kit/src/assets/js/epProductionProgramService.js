...
export function renderProductVariantProbability( vmo, containerElement ) {
    if( vmo.props[ epBvrConstants.MFG_PRODUCTION_RATE ] && vmo.totalProductionRate ) {
        containerElement.append( calculateProductVariantProbability( vmo ) );
    }
}

/**
 * calculate ProductVariant Probability
 * @param {*} vmo
 * @returns number
 */
export function calculateProductVariantProbability( vmo ) {
    if( vmo.props[ epBvrConstants.MFG_PRODUCTION_RATE ] && vmo.totalProductionRate ) {
...
export default {
    ...
    addProbabilityColumn,
    renderProductVariantProbability,
    calculateProductVariantProbability
};
