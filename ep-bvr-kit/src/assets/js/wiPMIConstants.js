...
const constants = {
    ...
    PMI_ADD_UNCONFIGURED_EVENT_NAME: 'mci0AddUnConfiguredEvent',
    PMI_TARGET_ASSEMBLY: 'connectedPartTargetAssembly',
    PMI_CHARACTERISTICS_EVENT_NAME: 'mci0CharacteristicEvent',
    ...
    PMI_TEXT: 'mci0Text',
    PMI_AUTO_RESOLVED_META: 'mci0DynamicResolvedPmiMeta',
