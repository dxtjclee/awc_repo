...
import { svgString as miscTableHeaderApprovedForBriefcaseWorkflow16 } from 'image/miscTableHeaderApprovedForBriefcaseWorkflow16.svg';
...
/**
 * Generates Is Approved For Briefcase Export Header DOM Element
 *
 * @param { Object } containerElement - The container DOM Element of briefcaseExport Column
 */
let rendererApprovedForBriefcaseExportHeader = function( containerElement ) {
    let objectIcon = document.createElement( 'span' );
    objectIcon.className = 'aw-visual-indicator';
    objectIcon.title = 'Is Approved for Briefcase Export';
    objectIcon.innerHTML = miscTableHeaderApprovedForBriefcaseWorkflow16;
    objectIcon.style.height = '16px';
    objectIcon.style.width = '16px';
    objectIcon.style.paddingRight = '16px';
    objectIcon.style.cursor = 'pointer';
    containerElement.appendChild( objectIcon );
};
...
export default {
    ...
    rendererApprovedForBriefcaseExportHeader
};
