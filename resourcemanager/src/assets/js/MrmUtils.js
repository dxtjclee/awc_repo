...
export let generateSpinningGeometry = function( generateSpinningGeometryCheckboxValue ) {
    //If it is turning assembly then no need to generate spinning geometry.
    if( appCtxService.ctx.panelContext && appCtxService.ctx.panelContext.isRootTurningAssy ) {
        return false;
    }

    return generateSpinningGeometryCheckboxValue;
};
