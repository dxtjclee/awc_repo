...
/**
 * It returns id of MRL saved search template.
 */
export let getMRLPinnedSavedSearchTemplateId = function( searchContext ) {
    return searchContext.applicationPinnedSavedSearchTileTemplateId;
};

export default exports = {
    getMRLDashboardLocalizedMessage,
    getMRLNewResourcesFolderUid,
    getMRLPinnedSavedSearchTemplateId
};
